            ...
            <div className='row'>
                ...
                <div className='col-1-of-6'>
                    ...
                    <div className='listingform__section'>
                        ...
                        <input type='text' className='listingform__input' name='keywords' onChange={e=>onChange(e)} value={keywords} />
                    </div>
                </div>
                ...
                <div className='col-1-of-6'>
                    ...
                    <div className='listingform__altsection'>
                        ...
                        <input type='checkbox' className='listingform__checkbox' name='open_house' onChange={e=>onChange(e)} value={open_house} />
                    </div>
                </div>
